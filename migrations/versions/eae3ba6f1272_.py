...
Revision ID: eae3ba6f1272
Revises: 
Create Date: 2022-08-08 18:35:36.967636
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('genres_id', 'artists_id')
    )
    ...
    sa.PrimaryKeyConstraint('genres_id', 'venues_id')
    )
